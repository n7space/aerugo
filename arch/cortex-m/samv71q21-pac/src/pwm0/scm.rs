...
pub type UPDM_W<'a, const O: u8> = crate::FieldWriter<'a, SCM_SPEC, 2, O, UPDMSELECT_A>;
...
pub type PTRM_W<'a, const O: u8> = crate::BitWriter<'a, SCM_SPEC, O>;
...
pub type PTRCS_W<'a, const O: u8> = crate::FieldWriter<'a, SCM_SPEC, 3, O>;
impl R {
