...
pub type W = crate::W<CMUPD0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cpolup(&mut self) -> CPOLUP_W<CMUPD0_SPEC, 9> {
        CPOLUP_W::new(self)
    }
    #[doc = "Bit 13 - Channel Polarity Inversion Update"]
    #[inline(always)]
    #[must_use]
    pub fn cpolinvup(&mut self) -> CPOLINVUP_W<CMUPD0_SPEC, 13> {
...
#[doc = "PWM Channel Mode Update Register (ch_num = 0)\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cmupd0::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
