...
pub type CPRCNT_W<'a, const O: u8> = crate::FieldWriter<'a, CMPM_SPEC, 4, O>;
...
pub type CUPR_W<'a, const O: u8> = crate::FieldWriter<'a, CMPM_SPEC, 4, O>;
...
pub type CUPRCNT_W<'a, const O: u8> = crate::FieldWriter<'a, CMPM_SPEC, 4, O>;
impl R {
