...
pub type MAXCNT_W<'a, const O: u8> = crate::FieldWriter<'a, ETRG2_SPEC, 24, O, u32>;
...
pub type TRGMODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, ETRG2_SPEC, 2, O, TRGMODESELECT_A>;
...
pub type TRGEDGE_W<'a, const O: u8> = crate::BitWriter<'a, ETRG2_SPEC, O, TRGEDGESELECT_A>;
...
pub type TRGFILT_W<'a, const O: u8> = crate::BitWriter<'a, ETRG2_SPEC, O>;
#[doc = "Field `TRGSRC` reader - Trigger Source"]
pub type TRGSRC_R = crate::BitReader;
#[doc = "Field `TRGSRC` writer - Trigger Source"]
pub type TRGSRC_W<'a, const O: u8> = crate::BitWriter<'a, ETRG2_SPEC, O>;
...
pub type RFEN_W<'a, const O: u8> = crate::BitWriter<'a, ETRG2_SPEC, O>;
impl R {
