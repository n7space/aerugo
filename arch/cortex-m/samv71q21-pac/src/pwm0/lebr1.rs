...
pub type R = crate::R<LEBR1_SPEC>;
#[doc = "Register `LEBR1` writer"]
pub type W = crate::W<LEBR1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lebdelay(&mut self) -> LEBDELAY_W<LEBR1_SPEC, 0> {
        LEBDELAY_W::new(self)
    }
    #[doc = "Bit 16 - PWML Falling Edge Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pwmlfen(&mut self) -> PWMLFEN_W<LEBR1_SPEC, 16> {
        PWMLFEN_W::new(self)
    }
    #[doc = "Bit 17 - PWML Rising Edge Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pwmlren(&mut self) -> PWMLREN_W<LEBR1_SPEC, 17> {
        PWMLREN_W::new(self)
    }
    #[doc = "Bit 18 - PWMH Falling Edge Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pwmhfen(&mut self) -> PWMHFEN_W<LEBR1_SPEC, 18> {
        PWMHFEN_W::new(self)
    }
    #[doc = "Bit 19 - PWMH Rising Edge Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pwmhren(&mut self) -> PWMHREN_W<LEBR1_SPEC, 19> {
        PWMHREN_W::new(self)
    }
