...
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, CSR_SPEC, O, ENABLESELECT_A>;
...
pub type TICKINT_W<'a, const O: u8> = crate::BitWriter<'a, CSR_SPEC, O, TICKINTSELECT_A>;
...
pub type CLKSOURCE_W<'a, const O: u8> = crate::BitWriter<'a, CSR_SPEC, O, CLKSOURCESELECT_A>;
