...
pub type CLRSTAT_W<'a, const O: u8> = crate::BitWriter<'a, NCR_SPEC, O>;
...
pub type INCSTAT_W<'a, const O: u8> = crate::BitWriter<'a, NCR_SPEC, O>;
...
pub type TXZQPF_W<'a, const O: u8> = crate::BitWriter<'a, NCR_SPEC, O>;
...
pub type SRTSM_W<'a, const O: u8> = crate::BitWriter<'a, NCR_SPEC, O>;
...
pub type ENPBPR_W<'a, const O: u8> = crate::BitWriter<'a, NCR_SPEC, O>;
...
pub type TXPBPF_W<'a, const O: u8> = crate::BitWriter<'a, NCR_SPEC, O>;
#[doc = "Field `FNP` reader - Flush Next Packet"]
pub type FNP_R = crate::BitReader;
#[doc = "Field `FNP` writer - Flush Next Packet"]
pub type FNP_W<'a, const O: u8> = crate::BitWriter<'a, NCR_SPEC, O>;
...
pub type TXLPIEN_W<'a, const O: u8> = crate::BitWriter<'a, NCR_SPEC, O>;
impl R {
