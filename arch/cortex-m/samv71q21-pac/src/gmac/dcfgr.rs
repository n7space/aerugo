...
pub type FBLDO_W<'a, const O: u8> = crate::FieldWriter<'a, DCFGR_SPEC, 5, O, FBLDOSELECT_A>;
...
pub type ESMA_W<'a, const O: u8> = crate::BitWriter<'a, DCFGR_SPEC, O>;
...
pub type ESPA_W<'a, const O: u8> = crate::BitWriter<'a, DCFGR_SPEC, O>;
...
pub type RXBMS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, DCFGR_SPEC, 2, O, RXBMSSELECT_A>;
...
pub type TXPBMS_W<'a, const O: u8> = crate::BitWriter<'a, DCFGR_SPEC, O>;
...
pub type TXCOEN_W<'a, const O: u8> = crate::BitWriter<'a, DCFGR_SPEC, O>;
...
pub type DRBS_W<'a, const O: u8> = crate::FieldWriter<'a, DCFGR_SPEC, 8, O>;
...
pub type DDRP_W<'a, const O: u8> = crate::BitWriter<'a, DCFGR_SPEC, O>;
impl R {
