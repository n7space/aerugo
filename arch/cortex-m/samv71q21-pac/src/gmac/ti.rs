...
pub type CNS_W<'a, const O: u8> = crate::FieldWriter<'a, TI_SPEC, 8, O>;
...
pub type ACNS_W<'a, const O: u8> = crate::FieldWriter<'a, TI_SPEC, 8, O>;
#[doc = "Field `NIT` reader - Number of Increments"]
pub type NIT_R = crate::FieldReader;
#[doc = "Field `NIT` writer - Number of Increments"]
pub type NIT_W<'a, const O: u8> = crate::FieldWriter<'a, TI_SPEC, 8, O>;
impl R {
