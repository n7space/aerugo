...
pub type RCOMP_W<'a, const O: u8> = crate::BitWriter<'a, IMRPQ_SPEC, O>;
#[doc = "Field `RXUBR` reader - RX Used Bit Read"]
pub type RXUBR_R = crate::BitReader;
#[doc = "Field `RXUBR` writer - RX Used Bit Read"]
pub type RXUBR_W<'a, const O: u8> = crate::BitWriter<'a, IMRPQ_SPEC, O>;
