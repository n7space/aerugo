...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn unre(&mut self) -> UNRE_W<IER_SPEC, 7> {
        UNRE_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn mcack(&mut self) -> MCACK_W<IER_SPEC, 16> {
        MCACK_W::new(self)
    }
    #[doc = "Bit 18 - Timeout Error Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn tout(&mut self) -> TOUT_W<IER_SPEC, 18> {
        TOUT_W::new(self)
    }
    #[doc = "Bit 19 - PEC Error Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pecerr(&mut self) -> PECERR_W<IER_SPEC, 19> {
        PECERR_W::new(self)
    }
    #[doc = "Bit 20 - SMBus Default Address Match Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn smbdam(&mut self) -> SMBDAM_W<IER_SPEC, 20> {
        SMBDAM_W::new(self)
    }
    #[doc = "Bit 21 - SMBus Host Header Address Match Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn smbhhm(&mut self) -> SMBHHM_W<IER_SPEC, 21> {
        SMBHHM_W::new(self)
    }
