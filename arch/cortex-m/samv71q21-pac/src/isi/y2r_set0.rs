...
pub type R = crate::R<Y2R_SET0_SPEC>;
#[doc = "Register `Y2R_SET0` writer"]
pub type W = crate::W<Y2R_SET0_SPEC>;
...
pub type C0_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type C1_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type C2_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type C3_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn c0(&mut self) -> C0_W<Y2R_SET0_SPEC, 0> {
        C0_W::new(self)
    }
    #[doc = "Bits 8:15 - Color Space Conversion Matrix Coefficient C1"]
    #[inline(always)]
    #[must_use]
    pub fn c1(&mut self) -> C1_W<Y2R_SET0_SPEC, 8> {
        C1_W::new(self)
    }
    #[doc = "Bits 16:23 - Color Space Conversion Matrix Coefficient C2"]
    #[inline(always)]
    #[must_use]
    pub fn c2(&mut self) -> C2_W<Y2R_SET0_SPEC, 16> {
        C2_W::new(self)
    }
    #[doc = "Bits 24:31 - Color Space Conversion Matrix Coefficient C3"]
    #[inline(always)]
    #[must_use]
    pub fn c3(&mut self) -> C3_W<Y2R_SET0_SPEC, 24> {
        C3_W::new(self)
    }
