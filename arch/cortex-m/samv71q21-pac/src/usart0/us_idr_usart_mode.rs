...
pub type RXRDY_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_USART_MODE_SPEC, O>;
#[doc = "Field `TXRDY` writer - TXRDY Interrupt Disable"]
pub type TXRDY_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_USART_MODE_SPEC, O>;
#[doc = "Field `RXBRK` writer - Receiver Break Interrupt Disable"]
pub type RXBRK_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_USART_MODE_SPEC, O>;
#[doc = "Field `OVRE` writer - Overrun Error Interrupt Enable"]
pub type OVRE_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_USART_MODE_SPEC, O>;
#[doc = "Field `FRAME` writer - Framing Error Interrupt Disable"]
pub type FRAME_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_USART_MODE_SPEC, O>;
#[doc = "Field `PARE` writer - Parity Error Interrupt Disable"]
pub type PARE_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_USART_MODE_SPEC, O>;
#[doc = "Field `TIMEOUT` writer - Timeout Interrupt Disable"]
pub type TIMEOUT_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_USART_MODE_SPEC, O>;
#[doc = "Field `TXEMPTY` writer - TXEMPTY Interrupt Disable"]
pub type TXEMPTY_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_USART_MODE_SPEC, O>;
#[doc = "Field `ITER` writer - Max Number of Repetitions Reached Interrupt Disable"]
pub type ITER_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_USART_MODE_SPEC, O>;
#[doc = "Field `NACK` writer - Non Acknowledge Interrupt Disable"]
pub type NACK_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_USART_MODE_SPEC, O>;
#[doc = "Field `RIIC` writer - Ring Indicator Input Change Disable"]
pub type RIIC_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_USART_MODE_SPEC, O>;
#[doc = "Field `DSRIC` writer - Data Set Ready Input Change Disable"]
pub type DSRIC_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_USART_MODE_SPEC, O>;
#[doc = "Field `DCDIC` writer - Data Carrier Detect Input Change Interrupt Disable"]
pub type DCDIC_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_USART_MODE_SPEC, O>;
#[doc = "Field `CTSIC` writer - Clear to Send Input Change Interrupt Disable"]
pub type CTSIC_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_USART_MODE_SPEC, O>;
#[doc = "Field `MANE` writer - Manchester Error Interrupt Disable"]
pub type MANE_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_USART_MODE_SPEC, O>;
impl W {
