...
pub type W = crate::W<US_IER_LON_MODE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rxrdy(&mut self) -> RXRDY_W<US_IER_LON_MODE_SPEC, 0> {
        RXRDY_W::new(self)
    }
    #[doc = "Bit 1 - TXRDY Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn txrdy(&mut self) -> TXRDY_W<US_IER_LON_MODE_SPEC, 1> {
        TXRDY_W::new(self)
    }
    #[doc = "Bit 5 - Overrun Error Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ovre(&mut self) -> OVRE_W<US_IER_LON_MODE_SPEC, 5> {
        OVRE_W::new(self)
    }
    #[doc = "Bit 6 - LON Short Frame Error Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lsfe(&mut self) -> LSFE_W<US_IER_LON_MODE_SPEC, 6> {
        LSFE_W::new(self)
    }
    #[doc = "Bit 7 - LON CRC Error Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lcrce(&mut self) -> LCRCE_W<US_IER_LON_MODE_SPEC, 7> {
        LCRCE_W::new(self)
    }
    #[doc = "Bit 9 - TXEMPTY Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn txempty(&mut self) -> TXEMPTY_W<US_IER_LON_MODE_SPEC, 9> {
        TXEMPTY_W::new(self)
    }
    #[doc = "Bit 10 - Underrun Error Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn unre(&mut self) -> UNRE_W<US_IER_LON_MODE_SPEC, 10> {
        UNRE_W::new(self)
    }
    #[doc = "Bit 24 - LON Transmission Done Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ltxd(&mut self) -> LTXD_W<US_IER_LON_MODE_SPEC, 24> {
        LTXD_W::new(self)
    }
    #[doc = "Bit 25 - LON Collision Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lcol(&mut self) -> LCOL_W<US_IER_LON_MODE_SPEC, 25> {
        LCOL_W::new(self)
    }
    #[doc = "Bit 26 - LON Frame Early Termination Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lfet(&mut self) -> LFET_W<US_IER_LON_MODE_SPEC, 26> {
        LFET_W::new(self)
    }
    #[doc = "Bit 27 - LON Reception Done Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lrxd(&mut self) -> LRXD_W<US_IER_LON_MODE_SPEC, 27> {
        LRXD_W::new(self)
    }
    #[doc = "Bit 28 - LON Backlog Overflow Error Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lblovfe(&mut self) -> LBLOVFE_W<US_IER_LON_MODE_SPEC, 28> {
        LBLOVFE_W::new(self)
    }
...
#[doc = "Interrupt Enable Register\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`us_ier_lon_mode::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
