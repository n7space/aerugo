...
pub type RSTRX_W<'a, const O: u8> = crate::BitWriter<'a, US_CR_SPI_MODE_SPEC, O>;
#[doc = "Field `RSTTX` writer - Reset Transmitter"]
pub type RSTTX_W<'a, const O: u8> = crate::BitWriter<'a, US_CR_SPI_MODE_SPEC, O>;
#[doc = "Field `RXEN` writer - Receiver Enable"]
pub type RXEN_W<'a, const O: u8> = crate::BitWriter<'a, US_CR_SPI_MODE_SPEC, O>;
#[doc = "Field `RXDIS` writer - Receiver Disable"]
pub type RXDIS_W<'a, const O: u8> = crate::BitWriter<'a, US_CR_SPI_MODE_SPEC, O>;
#[doc = "Field `TXEN` writer - Transmitter Enable"]
pub type TXEN_W<'a, const O: u8> = crate::BitWriter<'a, US_CR_SPI_MODE_SPEC, O>;
#[doc = "Field `TXDIS` writer - Transmitter Disable"]
pub type TXDIS_W<'a, const O: u8> = crate::BitWriter<'a, US_CR_SPI_MODE_SPEC, O>;
#[doc = "Field `RSTSTA` writer - Reset Status Bits"]
pub type RSTSTA_W<'a, const O: u8> = crate::BitWriter<'a, US_CR_SPI_MODE_SPEC, O>;
#[doc = "Field `FCS` writer - Force SPI Chip Select"]
pub type FCS_W<'a, const O: u8> = crate::BitWriter<'a, US_CR_SPI_MODE_SPEC, O>;
#[doc = "Field `RCS` writer - Release SPI Chip Select"]
pub type RCS_W<'a, const O: u8> = crate::BitWriter<'a, US_CR_SPI_MODE_SPEC, O>;
impl W {
