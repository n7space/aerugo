...
pub type RXRDY_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_LON_MODE_SPEC, O>;
#[doc = "Field `TXRDY` writer - TXRDY Interrupt Disable"]
pub type TXRDY_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_LON_MODE_SPEC, O>;
#[doc = "Field `OVRE` writer - Overrun Error Interrupt Enable"]
pub type OVRE_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_LON_MODE_SPEC, O>;
#[doc = "Field `LSFE` writer - LON Short Frame Error Interrupt Disable"]
pub type LSFE_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_LON_MODE_SPEC, O>;
#[doc = "Field `LCRCE` writer - LON CRC Error Interrupt Disable"]
pub type LCRCE_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_LON_MODE_SPEC, O>;
#[doc = "Field `TXEMPTY` writer - TXEMPTY Interrupt Disable"]
pub type TXEMPTY_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_LON_MODE_SPEC, O>;
#[doc = "Field `UNRE` writer - SPI Underrun Error Interrupt Disable"]
pub type UNRE_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_LON_MODE_SPEC, O>;
#[doc = "Field `LTXD` writer - LON Transmission Done Interrupt Disable"]
pub type LTXD_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_LON_MODE_SPEC, O>;
#[doc = "Field `LCOL` writer - LON Collision Interrupt Disable"]
pub type LCOL_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_LON_MODE_SPEC, O>;
#[doc = "Field `LFET` writer - LON Frame Early Termination Interrupt Disable"]
pub type LFET_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_LON_MODE_SPEC, O>;
#[doc = "Field `LRXD` writer - LON Reception Done Interrupt Disable"]
pub type LRXD_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_LON_MODE_SPEC, O>;
#[doc = "Field `LBLOVFE` writer - LON Backlog Overflow Error Interrupt Disable"]
pub type LBLOVFE_W<'a, const O: u8> = crate::BitWriter<'a, US_IDR_LON_MODE_SPEC, O>;
impl W {
