...
pub type OUT0_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 3, O, OUT0SELECT_A>;
...
pub type OUT1_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 3, O, OUT1SELECT_A>;
...
pub type THIGH_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 3, O, THIGHSELECT_A>;
...
pub type TPERIOD_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 2, O, TPERIODSELECT_A>;
