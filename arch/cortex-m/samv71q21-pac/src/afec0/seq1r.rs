...
pub type USCH0_W<'a, const O: u8> = crate::FieldWriter<'a, SEQ1R_SPEC, 4, O>;
...
pub type USCH1_W<'a, const O: u8> = crate::FieldWriter<'a, SEQ1R_SPEC, 4, O>;
...
pub type USCH2_W<'a, const O: u8> = crate::FieldWriter<'a, SEQ1R_SPEC, 4, O>;
...
pub type USCH3_W<'a, const O: u8> = crate::FieldWriter<'a, SEQ1R_SPEC, 4, O>;
...
pub type USCH4_W<'a, const O: u8> = crate::FieldWriter<'a, SEQ1R_SPEC, 4, O>;
...
pub type USCH5_W<'a, const O: u8> = crate::FieldWriter<'a, SEQ1R_SPEC, 4, O>;
...
pub type USCH6_W<'a, const O: u8> = crate::FieldWriter<'a, SEQ1R_SPEC, 4, O>;
...
pub type USCH7_W<'a, const O: u8> = crate::FieldWriter<'a, SEQ1R_SPEC, 4, O>;
impl R {
