...
pub type CMPMODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, EMR_SPEC, 2, O, CMPMODESELECT_A>;
...
pub type CMPSEL_W<'a, const O: u8> = crate::FieldWriter<'a, EMR_SPEC, 5, O>;
...
pub type CMPALL_W<'a, const O: u8> = crate::BitWriter<'a, EMR_SPEC, O>;
...
pub type CMPFILTER_W<'a, const O: u8> = crate::FieldWriter<'a, EMR_SPEC, 2, O>;
...
pub type RES_W<'a, const O: u8> = crate::FieldWriter<'a, EMR_SPEC, 3, O, RESSELECT_A>;
...
pub type TAG_W<'a, const O: u8> = crate::BitWriter<'a, EMR_SPEC, O>;
#[doc = "Field `STM` reader - Single Trigger Mode"]
pub type STM_R = crate::BitReader;
#[doc = "Field `STM` writer - Single Trigger Mode"]
pub type STM_W<'a, const O: u8> = crate::BitWriter<'a, EMR_SPEC, O>;
...
pub type SIGNMODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, EMR_SPEC, 2, O, SIGNMODESELECT_A>;
