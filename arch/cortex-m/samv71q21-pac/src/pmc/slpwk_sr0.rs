...
pub type R = crate::R<SLPWK_SR0_SPEC>;
...
#[doc = "SleepWalking Status Register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`slpwk_sr0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
