...
pub type R = crate::R<MCKR_SPEC>;
#[doc = "Register `MCKR` writer"]
pub type W = crate::W<MCKR_SPEC>;
...
pub type CSS_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 2, O, CSSSELECT_A>;
...
pub type PRES_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 3, O, PRESSELECT_A>;
...
pub type MDIV_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 2, O, MDIVSELECT_A>;
impl<'a, REG, const O: u8> MDIV_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn css(&mut self) -> CSS_W<MCKR_SPEC, 0> {
        CSS_W::new(self)
    }
    #[doc = "Bits 4:6 - Processor Clock Prescaler"]
    #[inline(always)]
    #[must_use]
    pub fn pres(&mut self) -> PRES_W<MCKR_SPEC, 4> {
        PRES_W::new(self)
    }
    #[doc = "Bits 8:9 - Master Clock Division"]
    #[inline(always)]
    #[must_use]
    pub fn mdiv(&mut self) -> MDIV_W<MCKR_SPEC, 8> {
        MDIV_W::new(self)
    }
    #[doc = "Bit 13 - UPLL Divider by 2"]
    #[inline(always)]
    #[must_use]
    pub fn uplldiv2(&mut self) -> UPLLDIV2_W<MCKR_SPEC, 13> {
        UPLLDIV2_W::new(self)
    }
