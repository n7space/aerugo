...
pub type R = crate::R<SLPWK_SR1_SPEC>;
...
#[doc = "SleepWalking Status Register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`slpwk_sr1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
