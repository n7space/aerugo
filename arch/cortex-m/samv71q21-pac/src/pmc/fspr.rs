...
pub type R = crate::R<FSPR_SPEC>;
#[doc = "Register `FSPR` writer"]
pub type W = crate::W<FSPR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fstp0(&mut self) -> FSTP0_W<FSPR_SPEC, 0> {
        FSTP0_W::new(self)
    }
    #[doc = "Bit 1 - Fast Startup Input Polarity 1"]
    #[inline(always)]
    #[must_use]
    pub fn fstp1(&mut self) -> FSTP1_W<FSPR_SPEC, 1> {
        FSTP1_W::new(self)
    }
    #[doc = "Bit 2 - Fast Startup Input Polarity 2"]
    #[inline(always)]
    #[must_use]
    pub fn fstp2(&mut self) -> FSTP2_W<FSPR_SPEC, 2> {
        FSTP2_W::new(self)
    }
    #[doc = "Bit 3 - Fast Startup Input Polarity 3"]
    #[inline(always)]
    #[must_use]
    pub fn fstp3(&mut self) -> FSTP3_W<FSPR_SPEC, 3> {
        FSTP3_W::new(self)
    }
    #[doc = "Bit 4 - Fast Startup Input Polarity 4"]
    #[inline(always)]
    #[must_use]
    pub fn fstp4(&mut self) -> FSTP4_W<FSPR_SPEC, 4> {
        FSTP4_W::new(self)
    }
    #[doc = "Bit 5 - Fast Startup Input Polarity 5"]
    #[inline(always)]
    #[must_use]
    pub fn fstp5(&mut self) -> FSTP5_W<FSPR_SPEC, 5> {
        FSTP5_W::new(self)
    }
    #[doc = "Bit 6 - Fast Startup Input Polarity 6"]
    #[inline(always)]
    #[must_use]
    pub fn fstp6(&mut self) -> FSTP6_W<FSPR_SPEC, 6> {
        FSTP6_W::new(self)
    }
    #[doc = "Bit 7 - Fast Startup Input Polarity 7"]
    #[inline(always)]
    #[must_use]
    pub fn fstp7(&mut self) -> FSTP7_W<FSPR_SPEC, 7> {
        FSTP7_W::new(self)
    }
    #[doc = "Bit 8 - Fast Startup Input Polarity 8"]
    #[inline(always)]
    #[must_use]
    pub fn fstp8(&mut self) -> FSTP8_W<FSPR_SPEC, 8> {
        FSTP8_W::new(self)
    }
    #[doc = "Bit 9 - Fast Startup Input Polarity 9"]
    #[inline(always)]
    #[must_use]
    pub fn fstp9(&mut self) -> FSTP9_W<FSPR_SPEC, 9> {
        FSTP9_W::new(self)
    }
    #[doc = "Bit 10 - Fast Startup Input Polarity 10"]
    #[inline(always)]
    #[must_use]
    pub fn fstp10(&mut self) -> FSTP10_W<FSPR_SPEC, 10> {
        FSTP10_W::new(self)
    }
    #[doc = "Bit 11 - Fast Startup Input Polarity 11"]
    #[inline(always)]
    #[must_use]
    pub fn fstp11(&mut self) -> FSTP11_W<FSPR_SPEC, 11> {
        FSTP11_W::new(self)
    }
    #[doc = "Bit 12 - Fast Startup Input Polarity 12"]
    #[inline(always)]
    #[must_use]
    pub fn fstp12(&mut self) -> FSTP12_W<FSPR_SPEC, 12> {
        FSTP12_W::new(self)
    }
    #[doc = "Bit 13 - Fast Startup Input Polarity 13"]
    #[inline(always)]
    #[must_use]
    pub fn fstp13(&mut self) -> FSTP13_W<FSPR_SPEC, 13> {
        FSTP13_W::new(self)
    }
    #[doc = "Bit 14 - Fast Startup Input Polarity 14"]
    #[inline(always)]
    #[must_use]
    pub fn fstp14(&mut self) -> FSTP14_W<FSPR_SPEC, 14> {
        FSTP14_W::new(self)
    }
    #[doc = "Bit 15 - Fast Startup Input Polarity 15"]
    #[inline(always)]
    #[must_use]
    pub fn fstp15(&mut self) -> FSTP15_W<FSPR_SPEC, 15> {
        FSTP15_W::new(self)
    }
