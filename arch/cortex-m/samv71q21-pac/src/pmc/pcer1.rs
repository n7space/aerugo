...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pid32(&mut self) -> PID32_W<PCER1_SPEC, 0> {
        PID32_W::new(self)
    }
    #[doc = "Bit 1 - Peripheral Clock 33 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid33(&mut self) -> PID33_W<PCER1_SPEC, 1> {
        PID33_W::new(self)
    }
    #[doc = "Bit 2 - Peripheral Clock 34 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid34(&mut self) -> PID34_W<PCER1_SPEC, 2> {
        PID34_W::new(self)
    }
    #[doc = "Bit 3 - Peripheral Clock 35 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid35(&mut self) -> PID35_W<PCER1_SPEC, 3> {
        PID35_W::new(self)
    }
    #[doc = "Bit 5 - Peripheral Clock 37 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid37(&mut self) -> PID37_W<PCER1_SPEC, 5> {
        PID37_W::new(self)
    }
    #[doc = "Bit 7 - Peripheral Clock 39 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid39(&mut self) -> PID39_W<PCER1_SPEC, 7> {
        PID39_W::new(self)
    }
    #[doc = "Bit 8 - Peripheral Clock 40 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid40(&mut self) -> PID40_W<PCER1_SPEC, 8> {
        PID40_W::new(self)
    }
    #[doc = "Bit 9 - Peripheral Clock 41 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid41(&mut self) -> PID41_W<PCER1_SPEC, 9> {
        PID41_W::new(self)
    }
    #[doc = "Bit 10 - Peripheral Clock 42 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid42(&mut self) -> PID42_W<PCER1_SPEC, 10> {
        PID42_W::new(self)
    }
    #[doc = "Bit 11 - Peripheral Clock 43 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid43(&mut self) -> PID43_W<PCER1_SPEC, 11> {
        PID43_W::new(self)
    }
    #[doc = "Bit 12 - Peripheral Clock 44 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid44(&mut self) -> PID44_W<PCER1_SPEC, 12> {
        PID44_W::new(self)
    }
    #[doc = "Bit 13 - Peripheral Clock 45 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid45(&mut self) -> PID45_W<PCER1_SPEC, 13> {
        PID45_W::new(self)
    }
    #[doc = "Bit 14 - Peripheral Clock 46 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid46(&mut self) -> PID46_W<PCER1_SPEC, 14> {
        PID46_W::new(self)
    }
    #[doc = "Bit 15 - Peripheral Clock 47 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid47(&mut self) -> PID47_W<PCER1_SPEC, 15> {
        PID47_W::new(self)
    }
    #[doc = "Bit 16 - Peripheral Clock 48 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid48(&mut self) -> PID48_W<PCER1_SPEC, 16> {
        PID48_W::new(self)
    }
    #[doc = "Bit 17 - Peripheral Clock 49 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid49(&mut self) -> PID49_W<PCER1_SPEC, 17> {
        PID49_W::new(self)
    }
    #[doc = "Bit 18 - Peripheral Clock 50 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid50(&mut self) -> PID50_W<PCER1_SPEC, 18> {
        PID50_W::new(self)
    }
    #[doc = "Bit 19 - Peripheral Clock 51 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid51(&mut self) -> PID51_W<PCER1_SPEC, 19> {
        PID51_W::new(self)
    }
    #[doc = "Bit 20 - Peripheral Clock 52 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid52(&mut self) -> PID52_W<PCER1_SPEC, 20> {
        PID52_W::new(self)
    }
    #[doc = "Bit 21 - Peripheral Clock 53 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid53(&mut self) -> PID53_W<PCER1_SPEC, 21> {
        PID53_W::new(self)
    }
    #[doc = "Bit 24 - Peripheral Clock 56 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid56(&mut self) -> PID56_W<PCER1_SPEC, 24> {
        PID56_W::new(self)
    }
    #[doc = "Bit 25 - Peripheral Clock 57 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid57(&mut self) -> PID57_W<PCER1_SPEC, 25> {
        PID57_W::new(self)
    }
    #[doc = "Bit 26 - Peripheral Clock 58 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid58(&mut self) -> PID58_W<PCER1_SPEC, 26> {
        PID58_W::new(self)
    }
    #[doc = "Bit 27 - Peripheral Clock 59 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid59(&mut self) -> PID59_W<PCER1_SPEC, 27> {
        PID59_W::new(self)
    }
    #[doc = "Bit 28 - Peripheral Clock 60 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid60(&mut self) -> PID60_W<PCER1_SPEC, 28> {
        PID60_W::new(self)
    }
...
#[doc = "Peripheral Clock Enable Register 1\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pcer1::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
