...
pub type USBCLK_W<'a, const O: u8> = crate::BitWriter<'a, SCER_SPEC, O>;
#[doc = "Field `PCK0` writer - Programmable Clock 0 Output Enable"]
pub type PCK0_W<'a, const O: u8> = crate::BitWriter<'a, SCER_SPEC, O>;
#[doc = "Field `PCK1` writer - Programmable Clock 1 Output Enable"]
pub type PCK1_W<'a, const O: u8> = crate::BitWriter<'a, SCER_SPEC, O>;
#[doc = "Field `PCK2` writer - Programmable Clock 2 Output Enable"]
pub type PCK2_W<'a, const O: u8> = crate::BitWriter<'a, SCER_SPEC, O>;
#[doc = "Field `PCK3` writer - Programmable Clock 3 Output Enable"]
pub type PCK3_W<'a, const O: u8> = crate::BitWriter<'a, SCER_SPEC, O>;
#[doc = "Field `PCK4` writer - Programmable Clock 4 Output Enable"]
pub type PCK4_W<'a, const O: u8> = crate::BitWriter<'a, SCER_SPEC, O>;
#[doc = "Field `PCK5` writer - Programmable Clock 5 Output Enable"]
pub type PCK5_W<'a, const O: u8> = crate::BitWriter<'a, SCER_SPEC, O>;
#[doc = "Field `PCK6` writer - Programmable Clock 6 Output Enable"]
pub type PCK6_W<'a, const O: u8> = crate::BitWriter<'a, SCER_SPEC, O>;
#[doc = "Field `PCK7` writer - Programmable Clock 7 Output Enable"]
pub type PCK7_W<'a, const O: u8> = crate::BitWriter<'a, SCER_SPEC, O>;
impl W {
