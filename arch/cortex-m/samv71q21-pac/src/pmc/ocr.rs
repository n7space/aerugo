...
pub type R = crate::R<OCR_SPEC>;
#[doc = "Register `OCR` writer"]
pub type W = crate::W<OCR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cal4(&mut self) -> CAL4_W<OCR_SPEC, 0> {
        CAL4_W::new(self)
    }
    #[doc = "Bit 7 - Selection of Main RC Oscillator Calibration Bits for 4 MHz"]
    #[inline(always)]
    #[must_use]
    pub fn sel4(&mut self) -> SEL4_W<OCR_SPEC, 7> {
        SEL4_W::new(self)
    }
    #[doc = "Bits 8:14 - Main RC Oscillator Calibration Bits for 8 MHz"]
    #[inline(always)]
    #[must_use]
    pub fn cal8(&mut self) -> CAL8_W<OCR_SPEC, 8> {
        CAL8_W::new(self)
    }
    #[doc = "Bit 15 - Selection of Main RC Oscillator Calibration Bits for 8 MHz"]
    #[inline(always)]
    #[must_use]
    pub fn sel8(&mut self) -> SEL8_W<OCR_SPEC, 15> {
        SEL8_W::new(self)
    }
    #[doc = "Bits 16:22 - Main RC Oscillator Calibration Bits for 12 MHz"]
    #[inline(always)]
    #[must_use]
    pub fn cal12(&mut self) -> CAL12_W<OCR_SPEC, 16> {
        CAL12_W::new(self)
    }
    #[doc = "Bit 23 - Selection of Main RC Oscillator Calibration Bits for 12 MHz"]
    #[inline(always)]
    #[must_use]
    pub fn sel12(&mut self) -> SEL12_W<OCR_SPEC, 23> {
        SEL12_W::new(self)
    }
