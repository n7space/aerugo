...
pub type MOSCRCF_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O, MOSCRCFSELECT_A>;
...
pub type XT32KFME_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn waitmode(&mut self) -> WAITMODE_W<CKGR_MOR_SPEC, 2> {
        WAITMODE_W::new(self)
    }
    #[doc = "Bit 3 - Main RC Oscillator Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn xt32kfme(&mut self) -> XT32KFME_W<CKGR_MOR_SPEC, 26> {
        XT32KFME_W::new(self)
    }
