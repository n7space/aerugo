...
pub type LOCK_W<'a, const O: u8> = crate::BitWriter<'a, MLBC1_SPEC, O>;
...
pub type CLKM_W<'a, const O: u8> = crate::BitWriter<'a, MLBC1_SPEC, O>;
#[doc = "Field `NDA` reader - Node Device Address"]
pub type NDA_R = crate::FieldReader;
#[doc = "Field `NDA` writer - Node Device Address"]
pub type NDA_W<'a, const O: u8> = crate::FieldWriter<'a, MLBC1_SPEC, 8, O>;
impl R {
