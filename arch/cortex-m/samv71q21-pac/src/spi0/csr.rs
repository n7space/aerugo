...
pub type CPOL_W<'a, const O: u8> = crate::BitWriter<'a, CSR_SPEC, O, CPOLSELECT_A>;
...
pub type NCPHA_W<'a, const O: u8> = crate::BitWriter<'a, CSR_SPEC, O, NCPHASELECT_A>;
...
pub type CSNAAT_W<'a, const O: u8> = crate::BitWriter<'a, CSR_SPEC, O>;
...
pub type CSAAT_W<'a, const O: u8> = crate::BitWriter<'a, CSR_SPEC, O>;
...
pub type BITS_W<'a, const O: u8> = crate::FieldWriter<'a, CSR_SPEC, 4, O, BITSSELECT_A>;
...
pub type SCBR_W<'a, const O: u8> = crate::FieldWriter<'a, CSR_SPEC, 8, O>;
#[doc = "Field `DLYBS` reader - Delay Before SPCK"]
pub type DLYBS_R = crate::FieldReader;
#[doc = "Field `DLYBS` writer - Delay Before SPCK"]
pub type DLYBS_W<'a, const O: u8> = crate::FieldWriter<'a, CSR_SPEC, 8, O>;
...
pub type DLYBCT_W<'a, const O: u8> = crate::FieldWriter<'a, CSR_SPEC, 8, O>;
impl R {
