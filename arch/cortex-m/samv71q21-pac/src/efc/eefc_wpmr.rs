...
pub type R = crate::R<EEFC_WPMR_SPEC>;
#[doc = "Register `EEFC_WPMR` writer"]
pub type W = crate::W<EEFC_WPMR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wpen(&mut self) -> WPEN_W<EEFC_WPMR_SPEC, 0> {
        WPEN_W::new(self)
    }
    #[doc = "Bits 8:31 - Write Protection Key"]
    #[inline(always)]
    #[must_use]
    pub fn wpkey(&mut self) -> WPKEY_W<EEFC_WPMR_SPEC, 8> {
        WPKEY_W::new(self)
    }
