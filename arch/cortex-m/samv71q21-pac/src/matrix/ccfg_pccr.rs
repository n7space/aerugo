...
pub type TC0CC_W<'a, const O: u8> = crate::BitWriter<'a, CCFG_PCCR_SPEC, O>;
...
pub type I2SC0CC_W<'a, const O: u8> = crate::BitWriter<'a, CCFG_PCCR_SPEC, O>;
...
pub type I2SC1CC_W<'a, const O: u8> = crate::BitWriter<'a, CCFG_PCCR_SPEC, O>;
impl R {
