...
pub type R = crate::R<CSUS_SPEC>;
#[doc = "Register `CSUS` writer"]
pub type W = crate::W<CSUS_SPEC>;
...
pub type SUBS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 24, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn subs(&mut self) -> SUBS_W<CSUS_SPEC, 0> {
        SUBS_W::new(self)
    }
