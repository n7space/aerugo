...
pub type R = crate::R<GRS_SPEC>;
#[doc = "Register `GRS` writer"]
pub type W = crate::W<GRS_SPEC>;
...
pub type RS0_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS2_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS3_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS4_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS5_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS6_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS7_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS8_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS9_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS10_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS11_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS12_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS13_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS14_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS15_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS16_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS17_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS18_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS19_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS20_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS21_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS22_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RS23_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rs0(&mut self) -> RS0_W<GRS_SPEC, 0> {
        RS0_W::new(self)
    }
    #[doc = "Bit 1 - XDMAC Channel 1 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs1(&mut self) -> RS1_W<GRS_SPEC, 1> {
        RS1_W::new(self)
    }
    #[doc = "Bit 2 - XDMAC Channel 2 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs2(&mut self) -> RS2_W<GRS_SPEC, 2> {
        RS2_W::new(self)
    }
    #[doc = "Bit 3 - XDMAC Channel 3 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs3(&mut self) -> RS3_W<GRS_SPEC, 3> {
        RS3_W::new(self)
    }
    #[doc = "Bit 4 - XDMAC Channel 4 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs4(&mut self) -> RS4_W<GRS_SPEC, 4> {
        RS4_W::new(self)
    }
    #[doc = "Bit 5 - XDMAC Channel 5 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs5(&mut self) -> RS5_W<GRS_SPEC, 5> {
        RS5_W::new(self)
    }
    #[doc = "Bit 6 - XDMAC Channel 6 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs6(&mut self) -> RS6_W<GRS_SPEC, 6> {
        RS6_W::new(self)
    }
    #[doc = "Bit 7 - XDMAC Channel 7 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs7(&mut self) -> RS7_W<GRS_SPEC, 7> {
        RS7_W::new(self)
    }
    #[doc = "Bit 8 - XDMAC Channel 8 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs8(&mut self) -> RS8_W<GRS_SPEC, 8> {
        RS8_W::new(self)
    }
    #[doc = "Bit 9 - XDMAC Channel 9 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs9(&mut self) -> RS9_W<GRS_SPEC, 9> {
        RS9_W::new(self)
    }
    #[doc = "Bit 10 - XDMAC Channel 10 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs10(&mut self) -> RS10_W<GRS_SPEC, 10> {
        RS10_W::new(self)
    }
    #[doc = "Bit 11 - XDMAC Channel 11 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs11(&mut self) -> RS11_W<GRS_SPEC, 11> {
        RS11_W::new(self)
    }
    #[doc = "Bit 12 - XDMAC Channel 12 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs12(&mut self) -> RS12_W<GRS_SPEC, 12> {
        RS12_W::new(self)
    }
    #[doc = "Bit 13 - XDMAC Channel 13 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs13(&mut self) -> RS13_W<GRS_SPEC, 13> {
        RS13_W::new(self)
    }
    #[doc = "Bit 14 - XDMAC Channel 14 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs14(&mut self) -> RS14_W<GRS_SPEC, 14> {
        RS14_W::new(self)
    }
    #[doc = "Bit 15 - XDMAC Channel 15 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs15(&mut self) -> RS15_W<GRS_SPEC, 15> {
        RS15_W::new(self)
    }
    #[doc = "Bit 16 - XDMAC Channel 16 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs16(&mut self) -> RS16_W<GRS_SPEC, 16> {
        RS16_W::new(self)
    }
    #[doc = "Bit 17 - XDMAC Channel 17 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs17(&mut self) -> RS17_W<GRS_SPEC, 17> {
        RS17_W::new(self)
    }
    #[doc = "Bit 18 - XDMAC Channel 18 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs18(&mut self) -> RS18_W<GRS_SPEC, 18> {
        RS18_W::new(self)
    }
    #[doc = "Bit 19 - XDMAC Channel 19 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs19(&mut self) -> RS19_W<GRS_SPEC, 19> {
        RS19_W::new(self)
    }
    #[doc = "Bit 20 - XDMAC Channel 20 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs20(&mut self) -> RS20_W<GRS_SPEC, 20> {
        RS20_W::new(self)
    }
    #[doc = "Bit 21 - XDMAC Channel 21 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs21(&mut self) -> RS21_W<GRS_SPEC, 21> {
        RS21_W::new(self)
    }
    #[doc = "Bit 22 - XDMAC Channel 22 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs22(&mut self) -> RS22_W<GRS_SPEC, 22> {
        RS22_W::new(self)
    }
    #[doc = "Bit 23 - XDMAC Channel 23 Read Suspend Bit"]
    #[inline(always)]
    #[must_use]
    pub fn rs23(&mut self) -> RS23_W<GRS_SPEC, 23> {
        RS23_W::new(self)
    }
