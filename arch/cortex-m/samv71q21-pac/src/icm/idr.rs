...
pub type RHC_W<'a, const O: u8> = crate::FieldWriter<'a, IDR_SPEC, 4, O>;
#[doc = "Field `RDM` writer - Region Digest Mismatch Interrupt Disable"]
pub type RDM_W<'a, const O: u8> = crate::FieldWriter<'a, IDR_SPEC, 4, O>;
#[doc = "Field `RBE` writer - Region Bus Error Interrupt Disable"]
pub type RBE_W<'a, const O: u8> = crate::FieldWriter<'a, IDR_SPEC, 4, O>;
#[doc = "Field `RWC` writer - Region Wrap Condition Detected Interrupt Disable"]
pub type RWC_W<'a, const O: u8> = crate::FieldWriter<'a, IDR_SPEC, 4, O>;
#[doc = "Field `REC` writer - Region End bit Condition detected Interrupt Disable"]
pub type REC_W<'a, const O: u8> = crate::FieldWriter<'a, IDR_SPEC, 4, O>;
#[doc = "Field `RSU` writer - Region Status Updated Interrupt Disable"]
pub type RSU_W<'a, const O: u8> = crate::FieldWriter<'a, IDR_SPEC, 4, O>;
