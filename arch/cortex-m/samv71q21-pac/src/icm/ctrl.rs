...
pub type DISABLE_W<'a, const O: u8> = crate::BitWriter<'a, CTRL_SPEC, O>;
#[doc = "Field `SWRST` writer - Software Reset"]
pub type SWRST_W<'a, const O: u8> = crate::BitWriter<'a, CTRL_SPEC, O>;
#[doc = "Field `REHASH` writer - Recompute Internal Hash"]
pub type REHASH_W<'a, const O: u8> = crate::FieldWriter<'a, CTRL_SPEC, 4, O>;
#[doc = "Field `RMDIS` writer - Region Monitoring Disable"]
pub type RMDIS_W<'a, const O: u8> = crate::FieldWriter<'a, CTRL_SPEC, 4, O>;
#[doc = "Field `RMEN` writer - Region Monitoring Enable"]
pub type RMEN_W<'a, const O: u8> = crate::FieldWriter<'a, CTRL_SPEC, 4, O>;
impl W {
