...
pub type RHC_W<'a, const O: u8> = crate::FieldWriter<'a, IER_SPEC, 4, O>;
#[doc = "Field `RDM` writer - Region Digest Mismatch Interrupt Enable"]
pub type RDM_W<'a, const O: u8> = crate::FieldWriter<'a, IER_SPEC, 4, O>;
#[doc = "Field `RBE` writer - Region Bus Error Interrupt Enable"]
pub type RBE_W<'a, const O: u8> = crate::FieldWriter<'a, IER_SPEC, 4, O>;
#[doc = "Field `RWC` writer - Region Wrap Condition detected Interrupt Enable"]
pub type RWC_W<'a, const O: u8> = crate::FieldWriter<'a, IER_SPEC, 4, O>;
#[doc = "Field `REC` writer - Region End bit Condition Detected Interrupt Enable"]
pub type REC_W<'a, const O: u8> = crate::FieldWriter<'a, IER_SPEC, 4, O>;
#[doc = "Field `RSU` writer - Region Status Updated Interrupt Disable"]
pub type RSU_W<'a, const O: u8> = crate::FieldWriter<'a, IER_SPEC, 4, O>;
#[doc = "Field `URAD` writer - Undefined Register Access Detection Interrupt Enable"]
pub type URAD_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O>;
impl W {
