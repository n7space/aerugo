...
pub type SMM_W<'a, const O: u8> = crate::BitWriter<'a, MR_SPEC, O, SMMSELECT_A>;
...
pub type LLB_W<'a, const O: u8> = crate::BitWriter<'a, MR_SPEC, O, LLBSELECT_A>;
...
pub type WDRBT_W<'a, const O: u8> = crate::BitWriter<'a, MR_SPEC, O, WDRBTSELECT_A>;
...
pub type CSMODE_W<'a, const O: u8> = crate::FieldWriter<'a, MR_SPEC, 2, O, CSMODESELECT_A>;
...
pub type NBBITS_W<'a, const O: u8> = crate::FieldWriter<'a, MR_SPEC, 4, O, NBBITSSELECT_A>;
...
pub type DLYBCT_W<'a, const O: u8> = crate::FieldWriter<'a, MR_SPEC, 8, O>;
...
pub type DLYCS_W<'a, const O: u8> = crate::FieldWriter<'a, MR_SPEC, 8, O>;
impl R {
