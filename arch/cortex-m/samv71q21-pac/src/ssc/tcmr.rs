...
pub type CKS_W<'a, const O: u8> = crate::FieldWriter<'a, TCMR_SPEC, 2, O, CKSSELECT_A>;
...
pub type CKO_W<'a, const O: u8> = crate::FieldWriter<'a, TCMR_SPEC, 3, O, CKOSELECT_A>;
...
pub type CKI_W<'a, const O: u8> = crate::BitWriter<'a, TCMR_SPEC, O>;
...
pub type CKG_W<'a, const O: u8> = crate::FieldWriter<'a, TCMR_SPEC, 2, O, CKGSELECT_A>;
...
pub type START_W<'a, const O: u8> = crate::FieldWriter<'a, TCMR_SPEC, 4, O, STARTSELECT_A>;
...
pub type STTDLY_W<'a, const O: u8> = crate::FieldWriter<'a, TCMR_SPEC, 8, O>;
...
pub type PERIOD_W<'a, const O: u8> = crate::FieldWriter<'a, TCMR_SPEC, 8, O>;
impl R {
