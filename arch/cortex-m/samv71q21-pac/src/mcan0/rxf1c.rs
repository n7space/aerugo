...
pub type F1SA_W<'a, const O: u8> = crate::FieldWriter<'a, RXF1C_SPEC, 14, O, u16>;
...
pub type F1S_W<'a, const O: u8> = crate::FieldWriter<'a, RXF1C_SPEC, 7, O>;
...
pub type F1WM_W<'a, const O: u8> = crate::FieldWriter<'a, RXF1C_SPEC, 7, O>;
#[doc = "Field `F1OM` reader - FIFO 1 Operation Mode"]
pub type F1OM_R = crate::BitReader;
#[doc = "Field `F1OM` writer - FIFO 1 Operation Mode"]
pub type F1OM_W<'a, const O: u8> = crate::BitWriter<'a, RXF1C_SPEC, O>;
impl R {
