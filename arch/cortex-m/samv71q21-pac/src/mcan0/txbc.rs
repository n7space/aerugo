...
pub type TBSA_W<'a, const O: u8> = crate::FieldWriter<'a, TXBC_SPEC, 14, O, u16>;
...
pub type NDTB_W<'a, const O: u8> = crate::FieldWriter<'a, TXBC_SPEC, 6, O>;
...
pub type TFQS_W<'a, const O: u8> = crate::FieldWriter<'a, TXBC_SPEC, 6, O>;
#[doc = "Field `TFQM` reader - Tx FIFO/Queue Mode"]
pub type TFQM_R = crate::BitReader;
#[doc = "Field `TFQM` writer - Tx FIFO/Queue Mode"]
pub type TFQM_W<'a, const O: u8> = crate::BitWriter<'a, TXBC_SPEC, O>;
impl R {
