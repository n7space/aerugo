...
pub type DRDY_W<'a, const O: u8> = crate::BitWriter<'a, PCIDR_SPEC, O>;
#[doc = "Field `OVRE` writer - Parallel Capture Mode Overrun Error Interrupt Disable"]
pub type OVRE_W<'a, const O: u8> = crate::BitWriter<'a, PCIDR_SPEC, O>;
#[doc = "Field `ENDRX` writer - End of Reception Transfer Interrupt Disable"]
pub type ENDRX_W<'a, const O: u8> = crate::BitWriter<'a, PCIDR_SPEC, O>;
#[doc = "Field `RXBUFF` writer - Reception Buffer Full Interrupt Disable"]
pub type RXBUFF_W<'a, const O: u8> = crate::BitWriter<'a, PCIDR_SPEC, O>;
impl W {
