...
pub type RXINIS_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIFR_ISO_MODE_SPEC, O>;
#[doc = "Field `TXOUTIS` writer - Transmitted OUT Data Interrupt Set"]
pub type TXOUTIS_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIFR_ISO_MODE_SPEC, O>;
#[doc = "Field `UNDERFIS` writer - Underflow Interrupt Set"]
pub type UNDERFIS_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIFR_ISO_MODE_SPEC, O>;
#[doc = "Field `PERRIS` writer - Pipe Error Interrupt Set"]
pub type PERRIS_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIFR_ISO_MODE_SPEC, O>;
#[doc = "Field `NAKEDIS` writer - NAKed Interrupt Set"]
pub type NAKEDIS_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIFR_ISO_MODE_SPEC, O>;
#[doc = "Field `OVERFIS` writer - Overflow Interrupt Set"]
pub type OVERFIS_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIFR_ISO_MODE_SPEC, O>;
#[doc = "Field `CRCERRIS` writer - CRC Error Interrupt Set"]
pub type CRCERRIS_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIFR_ISO_MODE_SPEC, O>;
#[doc = "Field `SHORTPACKETIS` writer - Short Packet Interrupt Set"]
pub type SHORTPACKETIS_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIFR_ISO_MODE_SPEC, O>;
#[doc = "Field `NBUSYBKS` writer - Number of Busy Banks Set"]
pub type NBUSYBKS_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIFR_ISO_MODE_SPEC, O>;
impl W {
