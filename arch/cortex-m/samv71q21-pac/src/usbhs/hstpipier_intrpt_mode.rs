...
pub type RXINES_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIER_INTRPT_MODE_SPEC, O>;
#[doc = "Field `TXOUTES` writer - Transmitted OUT Data Interrupt Enable"]
pub type TXOUTES_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIER_INTRPT_MODE_SPEC, O>;
#[doc = "Field `UNDERFIES` writer - Underflow Interrupt Enable"]
pub type UNDERFIES_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIER_INTRPT_MODE_SPEC, O>;
#[doc = "Field `PERRES` writer - Pipe Error Interrupt Enable"]
pub type PERRES_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIER_INTRPT_MODE_SPEC, O>;
#[doc = "Field `NAKEDES` writer - NAKed Interrupt Enable"]
pub type NAKEDES_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIER_INTRPT_MODE_SPEC, O>;
#[doc = "Field `OVERFIES` writer - Overflow Interrupt Enable"]
pub type OVERFIES_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIER_INTRPT_MODE_SPEC, O>;
#[doc = "Field `RXSTALLDES` writer - Received STALLed Interrupt Enable"]
pub type RXSTALLDES_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIER_INTRPT_MODE_SPEC, O>;
#[doc = "Field `SHORTPACKETIES` writer - Short Packet Interrupt Enable"]
pub type SHORTPACKETIES_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIER_INTRPT_MODE_SPEC, O>;
#[doc = "Field `NBUSYBKES` writer - Number of Busy Banks Enable"]
pub type NBUSYBKES_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIER_INTRPT_MODE_SPEC, O>;
#[doc = "Field `PDISHDMAS` writer - Pipe Interrupts Disable HDMA Request Enable"]
pub type PDISHDMAS_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIER_INTRPT_MODE_SPEC, O>;
#[doc = "Field `PFREEZES` writer - Pipe Freeze Enable"]
pub type PFREEZES_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIER_INTRPT_MODE_SPEC, O>;
#[doc = "Field `RSTDTS` writer - Reset Data Toggle Enable"]
pub type RSTDTS_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIER_INTRPT_MODE_SPEC, O>;
impl W {
