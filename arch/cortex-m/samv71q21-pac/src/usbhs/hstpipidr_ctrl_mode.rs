...
pub type RXINEC_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIDR_CTRL_MODE_SPEC, O>;
#[doc = "Field `TXOUTEC` writer - Transmitted OUT Data Interrupt Disable"]
pub type TXOUTEC_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIDR_CTRL_MODE_SPEC, O>;
#[doc = "Field `TXSTPEC` writer - Transmitted SETUP Interrupt Disable"]
pub type TXSTPEC_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIDR_CTRL_MODE_SPEC, O>;
#[doc = "Field `PERREC` writer - Pipe Error Interrupt Disable"]
pub type PERREC_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIDR_CTRL_MODE_SPEC, O>;
#[doc = "Field `NAKEDEC` writer - NAKed Interrupt Disable"]
pub type NAKEDEC_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIDR_CTRL_MODE_SPEC, O>;
#[doc = "Field `OVERFIEC` writer - Overflow Interrupt Disable"]
pub type OVERFIEC_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIDR_CTRL_MODE_SPEC, O>;
#[doc = "Field `RXSTALLDEC` writer - Received STALLed Interrupt Disable"]
pub type RXSTALLDEC_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIDR_CTRL_MODE_SPEC, O>;
#[doc = "Field `SHORTPACKETIEC` writer - Short Packet Interrupt Disable"]
pub type SHORTPACKETIEC_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIDR_CTRL_MODE_SPEC, O>;
#[doc = "Field `NBUSYBKEC` writer - Number of Busy Banks Disable"]
pub type NBUSYBKEC_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIDR_CTRL_MODE_SPEC, O>;
#[doc = "Field `FIFOCONC` writer - FIFO Control Disable"]
pub type FIFOCONC_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIDR_CTRL_MODE_SPEC, O>;
#[doc = "Field `PDISHDMAC` writer - Pipe Interrupts Disable HDMA Request Disable"]
pub type PDISHDMAC_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIDR_CTRL_MODE_SPEC, O>;
#[doc = "Field `PFREEZEC` writer - Pipe Freeze Disable"]
pub type PFREEZEC_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPIDR_CTRL_MODE_SPEC, O>;
impl W {
