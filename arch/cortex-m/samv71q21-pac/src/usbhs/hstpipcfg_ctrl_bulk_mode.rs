...
pub type ALLOC_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPCFG_CTRL_BULK_MODE_SPEC, O>;
...
pub type PBK_W<'a, const O: u8> =
    crate::FieldWriter<'a, HSTPIPCFG_CTRL_BULK_MODE_SPEC, 2, O, PBKSELECT_A>;
...
pub type PSIZE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, HSTPIPCFG_CTRL_BULK_MODE_SPEC, 3, O, PSIZESELECT_A>;
...
pub type PTOKEN_W<'a, const O: u8> =
    crate::FieldWriter<'a, HSTPIPCFG_CTRL_BULK_MODE_SPEC, 2, O, PTOKENSELECT_A>;
...
pub type AUTOSW_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPCFG_CTRL_BULK_MODE_SPEC, O>;
...
pub type PTYPE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, HSTPIPCFG_CTRL_BULK_MODE_SPEC, 2, O, PTYPESELECT_A>;
...
pub type PEPNUM_W<'a, const O: u8> = crate::FieldWriter<'a, HSTPIPCFG_CTRL_BULK_MODE_SPEC, 4, O>;
#[doc = "Field `PINGEN` reader - Ping Enable"]
pub type PINGEN_R = crate::BitReader;
#[doc = "Field `PINGEN` writer - Ping Enable"]
pub type PINGEN_W<'a, const O: u8> = crate::BitWriter<'a, HSTPIPCFG_CTRL_BULK_MODE_SPEC, O>;
...
pub type BINTERVAL_W<'a, const O: u8> = crate::FieldWriter<'a, HSTPIPCFG_CTRL_BULK_MODE_SPEC, 8, O>;
impl R {
