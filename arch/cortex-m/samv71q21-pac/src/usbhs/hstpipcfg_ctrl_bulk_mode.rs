...
pub type R = crate::R<HSTPIPCFG_CTRL_BULK_MODE_SPEC>;
#[doc = "Register `HSTPIPCFG_CTRL_BULK_MODE[%s]` writer"]
pub type W = crate::W<HSTPIPCFG_CTRL_BULK_MODE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn alloc(&mut self) -> ALLOC_W<HSTPIPCFG_CTRL_BULK_MODE_SPEC, 1> {
        ALLOC_W::new(self)
    }
    #[doc = "Bits 2:3 - Pipe Banks"]
    #[inline(always)]
    #[must_use]
    pub fn pbk(&mut self) -> PBK_W<HSTPIPCFG_CTRL_BULK_MODE_SPEC, 2> {
        PBK_W::new(self)
    }
    #[doc = "Bits 4:6 - Pipe Size"]
    #[inline(always)]
    #[must_use]
    pub fn psize(&mut self) -> PSIZE_W<HSTPIPCFG_CTRL_BULK_MODE_SPEC, 4> {
        PSIZE_W::new(self)
    }
    #[doc = "Bits 8:9 - Pipe Token"]
    #[inline(always)]
    #[must_use]
    pub fn ptoken(&mut self) -> PTOKEN_W<HSTPIPCFG_CTRL_BULK_MODE_SPEC, 8> {
        PTOKEN_W::new(self)
    }
    #[doc = "Bit 10 - Automatic Switch"]
    #[inline(always)]
    #[must_use]
    pub fn autosw(&mut self) -> AUTOSW_W<HSTPIPCFG_CTRL_BULK_MODE_SPEC, 10> {
        AUTOSW_W::new(self)
    }
    #[doc = "Bits 12:13 - Pipe Type"]
    #[inline(always)]
    #[must_use]
    pub fn ptype(&mut self) -> PTYPE_W<HSTPIPCFG_CTRL_BULK_MODE_SPEC, 12> {
        PTYPE_W::new(self)
    }
    #[doc = "Bits 16:19 - Pipe Endpoint Number"]
    #[inline(always)]
    #[must_use]
    pub fn pepnum(&mut self) -> PEPNUM_W<HSTPIPCFG_CTRL_BULK_MODE_SPEC, 16> {
        PEPNUM_W::new(self)
    }
    #[doc = "Bit 20 - Ping Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pingen(&mut self) -> PINGEN_W<HSTPIPCFG_CTRL_BULK_MODE_SPEC, 20> {
        PINGEN_W::new(self)
    }
    #[doc = "Bits 24:31 - bInterval Parameter for the Bulk-Out/Ping Transaction"]
    #[inline(always)]
    #[must_use]
    pub fn binterval(&mut self) -> BINTERVAL_W<HSTPIPCFG_CTRL_BULK_MODE_SPEC, 24> {
