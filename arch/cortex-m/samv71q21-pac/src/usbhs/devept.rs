...
pub type EPEN9_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type EPRST9_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn epen9(&mut self) -> EPEN9_W<DEVEPT_SPEC, 9> {
        EPEN9_W::new(self)
    }
    #[doc = "Bit 16 - Endpoint 0 Reset"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn eprst9(&mut self) -> EPRST9_W<DEVEPT_SPEC, 25> {
        EPRST9_W::new(self)
    }
