...
pub type TXINIC_W<'a, const O: u8> = crate::BitWriter<'a, DEVEPTICR_CTRL_MODE_SPEC, O>;
#[doc = "Field `RXOUTIC` writer - Received OUT Data Interrupt Clear"]
pub type RXOUTIC_W<'a, const O: u8> = crate::BitWriter<'a, DEVEPTICR_CTRL_MODE_SPEC, O>;
#[doc = "Field `RXSTPIC` writer - Received SETUP Interrupt Clear"]
pub type RXSTPIC_W<'a, const O: u8> = crate::BitWriter<'a, DEVEPTICR_CTRL_MODE_SPEC, O>;
#[doc = "Field `NAKOUTIC` writer - NAKed OUT Interrupt Clear"]
pub type NAKOUTIC_W<'a, const O: u8> = crate::BitWriter<'a, DEVEPTICR_CTRL_MODE_SPEC, O>;
#[doc = "Field `NAKINIC` writer - NAKed IN Interrupt Clear"]
pub type NAKINIC_W<'a, const O: u8> = crate::BitWriter<'a, DEVEPTICR_CTRL_MODE_SPEC, O>;
#[doc = "Field `OVERFIC` writer - Overflow Interrupt Clear"]
pub type OVERFIC_W<'a, const O: u8> = crate::BitWriter<'a, DEVEPTICR_CTRL_MODE_SPEC, O>;
#[doc = "Field `STALLEDIC` writer - STALLed Interrupt Clear"]
pub type STALLEDIC_W<'a, const O: u8> = crate::BitWriter<'a, DEVEPTICR_CTRL_MODE_SPEC, O>;
#[doc = "Field `SHORTPACKETC` writer - Short Packet Interrupt Clear"]
pub type SHORTPACKETC_W<'a, const O: u8> = crate::BitWriter<'a, DEVEPTICR_CTRL_MODE_SPEC, O>;
impl W {
