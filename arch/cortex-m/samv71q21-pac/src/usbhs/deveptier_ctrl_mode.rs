...
pub type W = crate::W<DEVEPTIER_CTRL_MODE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn txines(&mut self) -> TXINES_W<DEVEPTIER_CTRL_MODE_SPEC, 0> {
        TXINES_W::new(self)
    }
    #[doc = "Bit 1 - Received OUT Data Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rxoutes(&mut self) -> RXOUTES_W<DEVEPTIER_CTRL_MODE_SPEC, 1> {
        RXOUTES_W::new(self)
    }
    #[doc = "Bit 2 - Received SETUP Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rxstpes(&mut self) -> RXSTPES_W<DEVEPTIER_CTRL_MODE_SPEC, 2> {
        RXSTPES_W::new(self)
    }
    #[doc = "Bit 3 - NAKed OUT Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn nakoutes(&mut self) -> NAKOUTES_W<DEVEPTIER_CTRL_MODE_SPEC, 3> {
        NAKOUTES_W::new(self)
    }
    #[doc = "Bit 4 - NAKed IN Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn nakines(&mut self) -> NAKINES_W<DEVEPTIER_CTRL_MODE_SPEC, 4> {
        NAKINES_W::new(self)
    }
    #[doc = "Bit 5 - Overflow Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn overfes(&mut self) -> OVERFES_W<DEVEPTIER_CTRL_MODE_SPEC, 5> {
        OVERFES_W::new(self)
    }
    #[doc = "Bit 6 - STALLed Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn stalledes(&mut self) -> STALLEDES_W<DEVEPTIER_CTRL_MODE_SPEC, 6> {
        STALLEDES_W::new(self)
    }
    #[doc = "Bit 7 - Short Packet Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn shortpacketes(&mut self) -> SHORTPACKETES_W<DEVEPTIER_CTRL_MODE_SPEC, 7> {
        SHORTPACKETES_W::new(self)
    }
    #[doc = "Bit 12 - Number of Busy Banks Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn nbusybkes(&mut self) -> NBUSYBKES_W<DEVEPTIER_CTRL_MODE_SPEC, 12> {
        NBUSYBKES_W::new(self)
    }
    #[doc = "Bit 13 - Kill IN Bank"]
    #[inline(always)]
    #[must_use]
    pub fn killbks(&mut self) -> KILLBKS_W<DEVEPTIER_CTRL_MODE_SPEC, 13> {
        KILLBKS_W::new(self)
    }
    #[doc = "Bit 14 - FIFO Control"]
    #[inline(always)]
    #[must_use]
    pub fn fifocons(&mut self) -> FIFOCONS_W<DEVEPTIER_CTRL_MODE_SPEC, 14> {
        FIFOCONS_W::new(self)
    }
    #[doc = "Bit 16 - Endpoint Interrupts Disable HDMA Request Enable"]
    #[inline(always)]
    #[must_use]
    pub fn epdishdmas(&mut self) -> EPDISHDMAS_W<DEVEPTIER_CTRL_MODE_SPEC, 16> {
        EPDISHDMAS_W::new(self)
    }
    #[doc = "Bit 17 - NYET Token Disable Enable"]
    #[inline(always)]
    #[must_use]
    pub fn nyetdiss(&mut self) -> NYETDISS_W<DEVEPTIER_CTRL_MODE_SPEC, 17> {
        NYETDISS_W::new(self)
    }
    #[doc = "Bit 18 - Reset Data Toggle Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rstdts(&mut self) -> RSTDTS_W<DEVEPTIER_CTRL_MODE_SPEC, 18> {
        RSTDTS_W::new(self)
    }
    #[doc = "Bit 19 - STALL Request Enable"]
    #[inline(always)]
    #[must_use]
    pub fn stallrqs(&mut self) -> STALLRQS_W<DEVEPTIER_CTRL_MODE_SPEC, 19> {
        STALLRQS_W::new(self)
    }
...
#[doc = "Device Endpoint Interrupt Enable Register\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`deveptier_ctrl_mode::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
