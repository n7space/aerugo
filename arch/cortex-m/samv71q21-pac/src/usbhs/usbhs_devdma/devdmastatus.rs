...
pub type CHANN_ENB_W<'a, const O: u8> = crate::BitWriter<'a, DEVDMASTATUS_SPEC, O>;
...
pub type CHANN_ACT_W<'a, const O: u8> = crate::BitWriter<'a, DEVDMASTATUS_SPEC, O>;
...
pub type END_TR_ST_W<'a, const O: u8> = crate::BitWriter<'a, DEVDMASTATUS_SPEC, O>;
...
pub type END_BF_ST_W<'a, const O: u8> = crate::BitWriter<'a, DEVDMASTATUS_SPEC, O>;
...
pub type DESC_LDST_W<'a, const O: u8> = crate::BitWriter<'a, DEVDMASTATUS_SPEC, O>;
...
pub type BUFF_COUNT_W<'a, const O: u8> = crate::FieldWriter<'a, DEVDMASTATUS_SPEC, 16, O, u16>;
impl R {
