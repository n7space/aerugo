...
pub type R = crate::R<DEVDMASTATUS_SPEC>;
#[doc = "Register `DEVDMASTATUS` writer"]
pub type W = crate::W<DEVDMASTATUS_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chann_enb(&mut self) -> CHANN_ENB_W<DEVDMASTATUS_SPEC, 0> {
        CHANN_ENB_W::new(self)
    }
    #[doc = "Bit 1 - Channel Active Status"]
    #[inline(always)]
    #[must_use]
    pub fn chann_act(&mut self) -> CHANN_ACT_W<DEVDMASTATUS_SPEC, 1> {
        CHANN_ACT_W::new(self)
    }
    #[doc = "Bit 4 - End of Channel Transfer Status"]
    #[inline(always)]
    #[must_use]
    pub fn end_tr_st(&mut self) -> END_TR_ST_W<DEVDMASTATUS_SPEC, 4> {
        END_TR_ST_W::new(self)
    }
    #[doc = "Bit 5 - End of Channel Buffer Status"]
    #[inline(always)]
    #[must_use]
    pub fn end_bf_st(&mut self) -> END_BF_ST_W<DEVDMASTATUS_SPEC, 5> {
        END_BF_ST_W::new(self)
    }
    #[doc = "Bit 6 - Descriptor Loaded Status"]
    #[inline(always)]
    #[must_use]
    pub fn desc_ldst(&mut self) -> DESC_LDST_W<DEVDMASTATUS_SPEC, 6> {
        DESC_LDST_W::new(self)
    }
    #[doc = "Bits 16:31 - Buffer Byte Count"]
    #[inline(always)]
    #[must_use]
    pub fn buff_count(&mut self) -> BUFF_COUNT_W<DEVDMASTATUS_SPEC, 16> {
