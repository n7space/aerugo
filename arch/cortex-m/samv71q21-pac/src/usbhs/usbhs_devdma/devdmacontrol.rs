...
pub type CHANN_ENB_W<'a, const O: u8> = crate::BitWriter<'a, DEVDMACONTROL_SPEC, O>;
...
pub type LDNXT_DSC_W<'a, const O: u8> = crate::BitWriter<'a, DEVDMACONTROL_SPEC, O>;
...
pub type END_TR_EN_W<'a, const O: u8> = crate::BitWriter<'a, DEVDMACONTROL_SPEC, O>;
...
pub type END_B_EN_W<'a, const O: u8> = crate::BitWriter<'a, DEVDMACONTROL_SPEC, O>;
...
pub type END_TR_IT_W<'a, const O: u8> = crate::BitWriter<'a, DEVDMACONTROL_SPEC, O>;
...
pub type END_BUFFIT_W<'a, const O: u8> = crate::BitWriter<'a, DEVDMACONTROL_SPEC, O>;
...
pub type DESC_LD_IT_W<'a, const O: u8> = crate::BitWriter<'a, DEVDMACONTROL_SPEC, O>;
...
pub type BURST_LCK_W<'a, const O: u8> = crate::BitWriter<'a, DEVDMACONTROL_SPEC, O>;
...
pub type BUFF_LENGTH_W<'a, const O: u8> = crate::FieldWriter<'a, DEVDMACONTROL_SPEC, 16, O, u16>;
impl R {
