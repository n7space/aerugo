...
pub type TXINIS_W<'a, const O: u8> = crate::BitWriter<'a, DEVEPTIFR_INTRPT_MODE_SPEC, O>;
#[doc = "Field `RXOUTIS` writer - Received OUT Data Interrupt Set"]
pub type RXOUTIS_W<'a, const O: u8> = crate::BitWriter<'a, DEVEPTIFR_INTRPT_MODE_SPEC, O>;
#[doc = "Field `RXSTPIS` writer - Received SETUP Interrupt Set"]
pub type RXSTPIS_W<'a, const O: u8> = crate::BitWriter<'a, DEVEPTIFR_INTRPT_MODE_SPEC, O>;
#[doc = "Field `NAKOUTIS` writer - NAKed OUT Interrupt Set"]
pub type NAKOUTIS_W<'a, const O: u8> = crate::BitWriter<'a, DEVEPTIFR_INTRPT_MODE_SPEC, O>;
#[doc = "Field `NAKINIS` writer - NAKed IN Interrupt Set"]
pub type NAKINIS_W<'a, const O: u8> = crate::BitWriter<'a, DEVEPTIFR_INTRPT_MODE_SPEC, O>;
#[doc = "Field `OVERFIS` writer - Overflow Interrupt Set"]
pub type OVERFIS_W<'a, const O: u8> = crate::BitWriter<'a, DEVEPTIFR_INTRPT_MODE_SPEC, O>;
#[doc = "Field `STALLEDIS` writer - STALLed Interrupt Set"]
pub type STALLEDIS_W<'a, const O: u8> = crate::BitWriter<'a, DEVEPTIFR_INTRPT_MODE_SPEC, O>;
#[doc = "Field `SHORTPACKETS` writer - Short Packet Interrupt Set"]
pub type SHORTPACKETS_W<'a, const O: u8> = crate::BitWriter<'a, DEVEPTIFR_INTRPT_MODE_SPEC, O>;
#[doc = "Field `NBUSYBKS` writer - Number of Busy Banks Interrupt Set"]
pub type NBUSYBKS_W<'a, const O: u8> = crate::BitWriter<'a, DEVEPTIFR_INTRPT_MODE_SPEC, O>;
impl W {
