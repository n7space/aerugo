...
pub type RXOR_W<'a, const O: u8> = crate::BitWriter<'a, SCR_SPEC, O>;
#[doc = "Field `TXUR` writer - Transmit Underrun Status Clear"]
pub type TXUR_W<'a, const O: u8> = crate::BitWriter<'a, SCR_SPEC, O>;
#[doc = "Field `RXORCH` writer - Receive Overrun Per Channel Status Clear"]
pub type RXORCH_W<'a, const O: u8> = crate::FieldWriter<'a, SCR_SPEC, 2, O>;
#[doc = "Field `TXURCH` writer - Transmit Underrun Per Channel Status Clear"]
pub type TXURCH_W<'a, const O: u8> = crate::FieldWriter<'a, SCR_SPEC, 2, O>;
impl W {
