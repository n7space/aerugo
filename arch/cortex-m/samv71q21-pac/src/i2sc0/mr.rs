...
pub type MODE_W<'a, const O: u8> = crate::BitWriter<'a, MR_SPEC, O, MODESELECT_A>;
...
pub type DATALENGTH_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, MR_SPEC, 3, O, DATALENGTHSELECT_A>;
...
pub type RXMONO_W<'a, const O: u8> = crate::BitWriter<'a, MR_SPEC, O>;
...
pub type TXDMA_W<'a, const O: u8> = crate::BitWriter<'a, MR_SPEC, O>;
...
pub type TXSAME_W<'a, const O: u8> = crate::BitWriter<'a, MR_SPEC, O>;
...
pub type IMCKDIV_W<'a, const O: u8> = crate::FieldWriter<'a, MR_SPEC, 6, O>;
...
pub type IMCKFS_W<'a, const O: u8> = crate::FieldWriter<'a, MR_SPEC, 6, O, IMCKFSSELECT_A>;
...
pub type IMCKMODE_W<'a, const O: u8> = crate::BitWriter<'a, MR_SPEC, O>;
#[doc = "Field `IWS` reader - I2SC_WS Slot Width"]
pub type IWS_R = crate::BitReader;
#[doc = "Field `IWS` writer - I2SC_WS Slot Width"]
pub type IWS_W<'a, const O: u8> = crate::BitWriter<'a, MR_SPEC, O>;
impl R {
